...
model = SALM.from_pretrained("/data3/gkook/model/canary-qwen-2.5b").bfloat16()
...
training_datasets_list = [ours_train_dataset]
evaluation_datasets_list = [ours_test_dataset]
...
training_args = TrainingArguments(
    output_dir='/data3/gkook/temp/agi/canary-qwen-2.5b_ft_result_v4', # Updated output directory
...
print("\n--- 파인튜닝 완료 ---")
output_lora_path = os.path.join('/data3/gkook/temp/agi/canary-qwen-2.5b_ft_result_v4/final', "lora_adapters")
