...
training_args = TrainingArguments(
    output_dir='/data3/gkook/temp/agi/canary-qwen-2.5b_ft_result', # Updated output directory
...
print("\n--- 파인튜닝 완료 ---")
output_lora_path = os.path.join('/data3/gkook/temp/agi/canary-qwen-2.5b_ft_result/final', "lora_adapters")
